...
class BPNParser(BaseParser):
    ...
    def detect(self, text: str, filename: str = "") -> bool:
        ...
        return "BANCO PROVINCIA NEUQUEN" in haystack or "BANCO PROVINCIA DEL NEUQUEN" in haystack

    DETECTION_KEYWORDS = ["BPN", "BANCO PROVINCIA NEUQUEN", "BANCO PROVINCIA DEL NEUQUEN"]
